...
const apiClient = {
  ...
  async searchTalents(filters?: {
    ...
    try {
      ...
      // If the API endpoint doesn't exist (405 error), return mock data for demonstration
      if (error.response?.status === 405) {
  ...
  // Mock data function for when the talents endpoint is not available
